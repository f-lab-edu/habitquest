...
public class GoogleAuthService implements SSOAuth {
  ...
  public TokenResponseDTO ssoLogin(String code) {
    ...
    //id token payload 추출
    Map<String, Object> payload = tokenProvider.getTokenPayloadClaim(ssoTokens.idToken());
    ...
    String accessToken = tokenProvider.createAccessToken(name, 1L);
    String refreshToken = tokenProvider.createRefreshToken(name,2L);
